...
class Router
{
    ...
    public function routeReq()
    {
        try {
            ...
            {
                //En théorie on arrive jamais ici car l'application ne doit pas appeler l'api sans préciser son controlleur ainsi que l'action demandée
                throw new Exception("L'API ne gère pas la page index");
            }
        } //fin du bloc try
